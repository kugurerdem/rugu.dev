...
Before starting on my own, I wanted to see if anyone else in Turkey has already built a split keyboard. I found a subreddit called [MechIstanbul](https://www.reddit.com/r/mechistanbul/), where there were lots of split keyboard builds. Although the subreddit itself seemed to be inactive, I realized that their Telegram group was still very active. There, I asked some of the questions I had in mind to the experts directly. :) Especially a member named Erdem (yes, we share the same name), who helped me a lot with which parts to order and from where for building a Corne keyboard.
...
![](./corne-first-iteration.jpg#75persize)
...
So, I asked a couple of my friends whether they would be interested in using the keyboard. Thankfully, [Mert](https://x.com/mertcobanov) was interested, so I handed my Lily58 over to him. 🙂

![](./halycon-lily58.jpg#75persize)
