...
In the following essay, I will reflect about my personal journey which led me
...
provide valuable guidance and inspiration for your own journey.

# Before College

When I was considerably around 6 or 7 years old, I used to hangout with my
[cousin](https://www.yuempek.com) a lot. Whenever I see him on his computer, he
would always be engaged in something interesting like developing recreational
applications.
...
to my cousin, he immediately had the idea of writing a code to create [this
...
me. Since that moment, he became one of my idols. Not only did he introduce me
to the concept of programming, but he also helped me explore the world of
...
already used on a daily basis and with the guidance of my aforementioned
cousin, I made the decision to embark on the journey of learning programming.

I have started to learn Javascript as a programming language because it was the
onlu programming language which could be easily executed directly in a web
browser, my cousin saw it as a great investment for the future,  and moreover,
the learning resources for Javascript were readily available.
...
manipulation utilites and so on. Instead, he would usually expect me to
implement these functionalities from scratch. Despite being sceptical of this
...
you are intereseted in, you can check: [My Canvas Javascript
...
concepts and sharpened my problem-solving skills. The combination of
guidance from my cousin and hands-on practice proved to be an invaluable
learning experience.
...
prepare for the entrance exam if I wanted to study a profession from one of the
top universities.
...
existing interest in analytical philosophy, I began to develop a greater
...
my options. However, various unfortunate events which occured in my life during
...
University, one of the top universities I mentioned above, had a highly flexible
Bachelorship of Mathematics program. Realizing that I could take around 14
elective courses, including the compulsory electives of the CS department, I
saw an opportunity to unofficially pursue a double-major with CS. I made the
decision to study mathematics at Bilkent University and utilize my elective
...
not finding a job despite being skilled in your area is very low. So, whether
...
Although I am satisfied with choosing the mathematics department and progressing
...
energy towards the pursuits which are more relevant to me. The amount of energy
...
# What values did studying Math provided to Me for Software Development
...
significant amount of patience as most of the mathematical concepts necessitate
...
interests shifted more towards different areas such as Computer Science.
...
In the last 3 years of my college (out of 5), I have started to lost my
attention regarding my degree. I think this was triggered by COVID-19 pandemic
case, combined with my increasing interest in more pragmatical areas such as
...
from mathematics and started exploring cryptocurrencies with a friend mine. We
...
done was basically to create a script that bought tokens and sent them to
various accounts of ours in the chain to increase the amount of airdrop which
we could potentially gain. Although the project detected and addressed the
activity, despite not gaining any rewards, this experience introduced me
valuable blockchain & programming concepts (like the patterns often used in
web3.js library and async/await mechanisms).
...
knowledge could be put into practical use.
...
software development job given my knowledge and skills. He basically
recommended me to one of his friends who was thinking about creating a startup
to make the opportunities in DeFi more accessable to traditional investors. I
...
project exceeded my experience, and the value that it will provide once it is
done didn't seem like will be able to match the effort required. This project
...
I often found myself in a place where I would want to disguss the decisions I
...
While working at my first Job, I have get the opportunity to meet with a very
...
"/switching-to-archlinux" >}}) I mention about how we met in a short passage as follows:
...
>refactor code at that speed, I would save a lot of time, I could have spend
>more time on thinking about the actual stuff with less friction as possible. I
>want to have this power.’ So I have look to his CV and realized that he was
...
From that point on, I began to frequently ask my him questions about software
...
on several projects, which has continued for a year now.
...
- Want to teach you how to fish instead of merely handing you a fish. This
  ...
  for solutions to your problems or, at times, demonstrating their own methods
